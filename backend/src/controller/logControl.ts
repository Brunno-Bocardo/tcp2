...
export async function filtrarLogs(req: Request, res: Response) {
    const command = new LogCommand(logRepository, req.query.limite as string, req.query.pagina as string, req.query.offset as string, req.query.evento as string, req.query.usuario as string)
